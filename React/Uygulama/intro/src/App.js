    ...
    return (
        <div>
          ...
          <section id="home">
            ...
            {/* <img src={cem} alt="Profile Picture" /> */}
            <img src="cem.jpeg" alt="Profile Picture" />
            <div className="icons">
              <a href="#" title="Twitter" ><i className="fa-brands fa-square-twitter fa-xl"></i></a>
              <a href="#" title="Instagram"><i className="fa-brands fa-square-instagram fa-xl"></i></a>
              <a href="#" title="LinkedIn"><i className="fa-brands fa-linkedin fa-xl"></i></a>
              <a href="#" title="GitHub"><i className="fa-brands fa-github fa-xl"></i></a>
              <a href="#" title="Facebook"><i className="fa-brands fa-facebook fa-xl"></i></a>
            </div>
          </section>
